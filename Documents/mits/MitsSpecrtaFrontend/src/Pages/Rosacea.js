      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
          ...
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-sm leading-8 text-gray-700">
                Rosacea is a prevalent condition that often affects the skin on
                the face. The nose, chin, cheeks, and forehead turn red as a
                result. It's possible that the redness will intensify and turn
                reddish over time. It's possible to see tiny blood vessels.
              </p>
            </div>
          </div>
        </div>
        <div className="-mt-12 -ml-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <img
            ...
            src="https://media.istockphoto.com/id/546459592/photo/elderly-woman-with-rosacea-facial-skin-disorder.jpg?s=612x612&w=0&k=20&c=bY1JZ05I9YRqqeYBUWQYUC73y9KixFpu8mfvcZ8o8AI="
            alt=""
          />
        </div>
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <p>
                Rosacea can occasionally show up on the scalp, neck, chest, or
                ears. Untreated rosacea can lead to pus-filled pimples and red,
                firm lumps. The condition may result in rhinophyma, a bulbous,
                bloated appearance of the nose. Rosacea can cause itching and
                bloodshot or watery eyes. Styes could happen. It is known as
                ocular rosacea.
              </p>
